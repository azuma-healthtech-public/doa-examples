...
///
/// Nothing here has a default. A build that names no tenant is not pointed at
/// anyone's backend by accident - it opens on a screen that says it is not
/// configured. `config.example.json` carries the values of azuma's demo tenant,
/// labelled as such; an integrator copies it and replaces them with their own.
abstract final class AppConfig {
  /// Backend base URL. Must be `https`.
  static const String baseUrl = String.fromEnvironment('DOA_BASE_URL');
