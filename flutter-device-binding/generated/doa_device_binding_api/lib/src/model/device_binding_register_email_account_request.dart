...
part 'device_binding_register_email_account_request.g.dart';
...
class DeviceBindingRegisterEmailAccountRequest {
  /// Returns a new [DeviceBindingRegisterEmailAccountRequest] instance.
  DeviceBindingRegisterEmailAccountRequest({
    ...
    required  this.initiateEmailVerification,
  ...
  final String? email;
      ...
      /// True if email verification should be initiated. False otherwise.
  @JsonKey(
    
    name: r'initiateEmailVerification',
    required: true,
    includeIfNull: false,
  )


  final bool initiateEmailVerification;
  ...
  final UserDeviceData? deviceData;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is DeviceBindingRegisterEmailAccountRequest &&
      other.language == language &&
      other.roleKey == roleKey &&
      other.licenseKey == licenseKey &&
      other.password == password &&
      other.email == email &&
      other.initiateEmailVerification == initiateEmailVerification &&
    ...
    int get hashCode =>
        ...
        initiateEmailVerification.hashCode +
  ...
  factory DeviceBindingRegisterEmailAccountRequest.fromJson(Map<String, dynamic> json) => _$DeviceBindingRegisterEmailAccountRequestFromJson(json);

  Map<String, dynamic> toJson() => _$DeviceBindingRegisterEmailAccountRequestToJson(this);
