...
part 'device_binding_register_additional_device_email_request.g.dart';
...
class DeviceBindingRegisterAdditionalDeviceEmailRequest {
  /// Returns a new [DeviceBindingRegisterAdditionalDeviceEmailRequest] instance.
  ...
  final String? androidIntegrityToken;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is DeviceBindingRegisterAdditionalDeviceEmailRequest &&
  ...
  factory DeviceBindingRegisterAdditionalDeviceEmailRequest.fromJson(Map<String, dynamic> json) => _$DeviceBindingRegisterAdditionalDeviceEmailRequestFromJson(json);

  Map<String, dynamic> toJson() => _$DeviceBindingRegisterAdditionalDeviceEmailRequestToJson(this);
