...
part 'device_binding_register_oidc_account_request.g.dart';
...
class DeviceBindingRegisterOidcAccountRequest {
  /// Returns a new [DeviceBindingRegisterOidcAccountRequest] instance.
  ...
  final UserDeviceData? deviceData;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is DeviceBindingRegisterOidcAccountRequest &&
  ...
  factory DeviceBindingRegisterOidcAccountRequest.fromJson(Map<String, dynamic> json) => _$DeviceBindingRegisterOidcAccountRequestFromJson(json);

  Map<String, dynamic> toJson() => _$DeviceBindingRegisterOidcAccountRequestToJson(this);
