...
part of 'device_binding_register_health_id_account_request.dart';
...
_$DeviceBindingRegisterHealthIdAccountRequestFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('DeviceBindingRegisterHealthIdAccountRequest', json, (
  $checkedConvert,
) {
  $checkKeys(
    json,
  ...
  final val = DeviceBindingRegisterHealthIdAccountRequest(
...
Map<String, dynamic> _$DeviceBindingRegisterHealthIdAccountRequestToJson(
  DeviceBindingRegisterHealthIdAccountRequest instance,
) => <String, dynamic>{
