...
part 'login_account_request.g.dart';
...
class LoginAccountRequest {
  /// Returns a new [LoginAccountRequest] instance.
  LoginAccountRequest({
  ...
  final DeviceBoundIntegrityVerificationData? deviceBoundIntegrityVerificationData;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is LoginAccountRequest &&
  ...
  Map<String, dynamic> toJson() => _$LoginAccountRequestToJson(this);
