...
class DeviceBindingAuthHealthIDApi {

  final Dio _dio;

  const DeviceBindingAuthHealthIDApi(this._dio);
  ...
  /// * [deviceBoundRequest] - Request payload. (Payload: <a href=\"#model-LoginHealthIdAccountRequest\">LoginHealthIdAccountRequest</a>).
  ...
  Future<Response<LoginResponse>> deviceBindingAuthLoginHealthId({ 
    ...
    final _path = r'/deviceBinding/auth/v1/mobile/{applicationId}/login/healthId'.replaceAll('{' r'applicationId' '}', applicationId.toString());
