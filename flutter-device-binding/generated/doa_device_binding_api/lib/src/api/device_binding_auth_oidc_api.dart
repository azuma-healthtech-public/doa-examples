...
class DeviceBindingAuthOIDCApi {

  final Dio _dio;

  const DeviceBindingAuthOIDCApi(this._dio);
  ...
  /// * [deviceBoundRequest] - Request payload. (Payload: <a href=\"#model-LoginOidcAccountRequest\">LoginOidcAccountRequest</a>).
  ...
  Future<Response<LoginResponse>> deviceBindingAuthLoginApple({ 
    ...
    final _path = r'/deviceBinding/auth/v1/mobile/{applicationId}/login/apple'.replaceAll('{' r'applicationId' '}', applicationId.toString());
...
_responseData = rawData == null ? null : deserialize<LoginResponse, LoginResponse>(rawData, 'LoginResponse', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [LoginResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LoginResponse>> deviceBindingAuthLoginGoogle({ 
    required String applicationId,
    DeviceBoundRequest? deviceBoundRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/deviceBinding/auth/v1/mobile/{applicationId}/login/google'.replaceAll('{' r'applicationId' '}', applicationId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
