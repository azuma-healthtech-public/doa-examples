...
class DeviceBindingAuthBiometricsApi {

  final Dio _dio;

  const DeviceBindingAuthBiometricsApi(this._dio);
  ...
  /// * [deviceBoundRequest] - Request payload. (Payload: <a href=\"#model-DeviceBindingBiometricsLoginRequest\">DeviceBindingBiometricsLoginRequest</a>).
  ...
  Future<Response<LoginResponse>> deviceBindingAuthLoginBiometrics({ 
    ...
    final _path = r'/deviceBinding/auth/v1/mobile/{applicationId}/login/biometrics'.replaceAll('{' r'applicationId' '}', applicationId.toString());
